...
public class PostTest {
    ...
    public void tearDown() {
        Post.clear(); //clear out allll the posts before each test.
    }
    ...
    public void getId_postsInstantiateWithAnID_1() throws Exception{
        Post.clear();  // Remember, the test will fail without this line! We need to empty leftover Posts from previous tests!
